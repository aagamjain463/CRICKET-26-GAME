...
def main():
    ...
    jobs = [
        ...
        ('A_C26_BattingBackFootDefence', authoring['batting_backfoot_defence_keys'](), 'A_C26_BattingDrive',
         1, 36, [('stance', 1), ('backlift', 13), ('contact', 23), ('absorb', 29)]),
        ('A_C26_BattingLateCut', authoring['batting_latecut_keys'](), 'A_C26_BattingDrive',
         1, 36, [('stance', 1), ('backlift', 13), ('contact', 23), ('follow', 29)]),
        ('A_C26_BattingUpperCut', authoring['batting_uppercut_keys'](), 'A_C26_BattingDrive',
         1, 36, [('stance', 1), ('backlift', 13), ('contact', 23), ('follow', 29)]),
        ...
        ('A_C26_UmpireSignalWide', authoring['umpire_signal_wide_keys'](), 'A_C26_BattingDrive',
         1, 36, [('ready', 1), ('signal', 14), ('hold', 22)]),
        ('A_C26_UmpireSignalSix', authoring['umpire_signal_six_keys'](), 'A_C26_BattingDrive',
         1, 36, [('ready', 1), ('signal', 14), ('hold', 22)]),
        ('A_C26_UmpireSignalOut', authoring['umpire_signal_out_keys'](), 'A_C26_BattingDrive',
         1, 36, [('ready', 1), ('signal', 14), ('hold', 22)]),
        ('A_C26_UmpireSignalFour', authoring['umpire_signal_four_keys'](), 'A_C26_BattingDrive',
         1, 36, [('ready', 1), ('sweepL', 10), ('sweepR', 18), ('signal', 24)]),
